...
{
   switch (algorithm) {
   case binary_search_tree::depth_first_algorithm::PRE_ORDER:
      {

      } break;
      case binary_search_tree::depth_first_algorithm::IN_ORDER:
      {

      } break;
      case binary_search_tree::depth_first_algorithm::POST_ORDER:
      {
