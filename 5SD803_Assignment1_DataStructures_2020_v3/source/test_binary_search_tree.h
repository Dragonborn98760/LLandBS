...
void test_binary_search_tree() 
{
   ...
   TEST_CASE(tree.contains(1));
   {
      ...
      linked_list list;
      tree.depth_first(list, binary_search_tree::depth_first_algorithm::IN_ORDER);
      int count = tree.size();
   ...
   TEST_BEGIN(binary_search_tree::depth_first::PRE_ORDER);
   {
      ...
      linked_list list;
      tree.depth_first(list, binary_search_tree::depth_first_algorithm::PRE_ORDER);
      for (int index = 0; index < count; index++) 
	  {
   ...
   TEST_BEGIN(binary_search_tree::depth_first::POST_ORDER);
   {
      ...
      linked_list list;
      tree.depth_first(list, binary_search_tree::depth_first_algorithm::POST_ORDER);
      for (int index = 0; index < count; index++) 
	  {
