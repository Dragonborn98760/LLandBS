...
// note: implementation required for pass with distinction only...
...
#pragma region For Unit Testing
   friend bool traverse(const int arr[], const unsigned int size, const doubly_linked_list& list);
   friend bool traverseReversed(const int arr[], const unsigned int size, const doubly_linked_list& list);
#pragma endregion
